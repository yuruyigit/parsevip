...
public class QQMusic {
	...
	private static String getAudioUrl(String url) throws IOException {
		...
		String audioUrl = "http://dl.stream.qqmusic.qq.com/"+filename+"?vkey="+vkey+"&guid="+guid+"&uin=0&fromtag=66";
